...
<div class="navbar">
    ...
    <div class="container">
        ...
        <div class="user-container">
            <h2><?php echo htmlspecialchars($translations['rselect_user_to_chat']); ?></h2>
            <ul>
    <?php while ($user_row = $users_result->fetch_assoc()) { ?>
        <!-- Link to report_user.php instead of chat.php -->
        <li><a href="reportr.php?user_id=<?php echo htmlspecialchars($user_row['id']); ?>"><h3><?php echo htmlspecialchars($user_row['username']); ?></h3></a></li><br>
    <?php } ?>
</ul>
        ...
        <div class="user-container">
            <h2><?php echo htmlspecialchars($translations['rurchat']); ?></h2>
            <ul>
    <?php while ($chatted_user_row = $chatted_users_result->fetch_assoc()) { ?>
        <!-- Link to report_user.php instead of chat.php -->
        <li><a href="reportr.php?user_id=<?php echo htmlspecialchars($chatted_user_row['id']); ?>"><h3><?php echo htmlspecialchars($chatted_user_row['username']); ?></h3></a></li><br>
    <?php } ?>
</ul>
    ...
    <div class="logout-container">
        <a href="reported.php" class="logout-link"><?php echo htmlspecialchars($translations['reported']); ?></a>
    </div>
</body>
</html>
